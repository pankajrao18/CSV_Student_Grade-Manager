...
def main():
    ...
    add_more = input("Do you want to add a new student manually? (yes/no): ")
    ...
    if add_more == "yes":
        try:
            ...
            if name.isalpha() == False:
                print("Invalid name! Only characters are allowed.")
            m1 = float(input("Enter Mark1: "))
            m2 = float(input("Enter Mark2: "))
            m3 = float(input("Enter Mark3: "))

            new_student = Student(student_id, name, m1, m2, m3)
